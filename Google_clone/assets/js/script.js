...
$(document).ready(function () {
    ...
    grid.masonry({
        itemSelector: ".gridItem", columnWidth:200,gutter:5,isInitLayout:false
    });
    ...
    $("[data-fancybox]").fancybox({
        caption : function( instance, item ) {
            ...
            if ( item.type === 'image' ) {
                caption = (caption.length ? caption + '<br />' : '') + '<a href="' + item.src + '">View image</a><br>' + '<a href="' + siteUrl+ '">Visit page</a><br>';
            }
